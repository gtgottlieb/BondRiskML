...
for maturity in range(1,Y.shape[1]):
    ...
    print(f"{maturity_name}: R²OOS={100*r2_oos:.3f}%, MSPE={mspe:.3f}, p-value={signif_p_value:.3f}")
    ...
    plt.savefig(f'/Users/avril/Desktop/Seminar/Python Code/Plots/NN3_Forecast_vs_True_{clean_name}.png', dpi=300)
    plt.close()
